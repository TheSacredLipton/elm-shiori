...
profileCard =
    div [ class "flex items-center justify-center p-6 bg-slate-50" ]
        [ div [ class "w-full max-w-xs bg-white rounded-2xl shadow-md overflow-hidden border border-slate-100 transition-all duration-300 hover:shadow-lg hover:-translate-y-1" ]
            [ div [ class "h-24 bg-gradient-to-r from-orange-400 to-amber-500" ] []
            , div [ class "px-6 pb-6 text-center" ]
                ...
                , div [ class "flex flex-wrap justify-center gap-1.5 mb-6" ]
                    [ span [ class "px-2 py-0.5 text-[10px] font-semibold bg-orange-50 text-orange-600 rounded-full" ] [ text "Elm" ]
    ...
    div [ class "flex items-center justify-center p-6 bg-slate-50" ]
        [ div [ class "w-full max-w-sm bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100 transition-all duration-300 hover:shadow-md" ]
            ...
            , div [ class "p-5" ]
                ...
                , h4 [ class "text-lg font-bold text-slate-800 mb-2 hover:text-orange-500 cursor-pointer transition-colors duration-150" ]
...
pricingSection =
    div [ class "py-8 px-4 bg-slate-50 text-center rounded-2xl border border-slate-100" ]
        ...
        , div [ class "flex flex-col md:flex-row justify-center items-center gap-6 max-w-4xl mx-auto" ]
            ...
            , div [ class "flex-1 w-full max-w-sm p-6 bg-white rounded-2xl border-2 border-orange-500 shadow-md relative overflow-hidden" ]
                [ div [ class "absolute top-0 right-0 bg-orange-500 text-white text-[9px] font-bold px-3 py-1 rounded-bl-lg uppercase tracking-wider" ] [ text "Popular" ]
                ...
                , button [ class "w-full py-2 bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold rounded-lg mb-6 shadow-sm shadow-orange-500/20 transition-colors duration-150" ]
                    [ text "Upgrade to Pro" ]
                , ul [ class "text-left text-xs text-slate-600 space-y-2.5 border-t border-slate-100 pt-6" ]
                    [ li [ class "flex items-center gap-2" ]
                        [ span [ class "text-emerald-500 font-bold" ] [ text "✓" ]
